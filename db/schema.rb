...
ActiveRecord::Schema.define(version: 20150228210902) do
  ...
  create_table "recipes", force: :cascade do |t|
    ...
    t.datetime "created_at",                  null: false
    t.datetime "updated_at",                  null: false
    t.integer  "favourite_count", default: 0, null: false
  end

  add_index "recipes", ["favourite_count"], name: "index_recipes_on_favourite_count", using: :btree
